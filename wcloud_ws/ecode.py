...
SMS_TEMP_ERROR  = ECode(25, '短信发送失败')
...
USER_ERROR_SIM=ECode(52,'sim卡与号不匹配')   #+++12.19
PUSHSEVER_NOT_EXIST=ECode(59,'推送服务器不存在')
CAPTHCA_IS_SENDED = ECode(60, '验证码已发送，请60s后再试')   #+++20150403
DEVS_NOT_LOGIN=ECode(61, '设备未激活')   #+++20150608
SYS_BUG=ECode(62,"系统维护中,请稍后登录")
CAPTHCA_ERROR = ECode(63, '验证码错误')   #+++20160105
